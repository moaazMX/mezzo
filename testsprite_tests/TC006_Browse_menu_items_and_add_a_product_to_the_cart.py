...
async def run_test():
    ...
    try:
        ...
        # -> Open the categories menu (the element labeled 'أصناف') to reveal the storefront menu items.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/div[2]/div/div').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Click the product 'إضافة' button to add an item to the cart (use index 163).
        frame = context.pages[-1]
        # Click element
